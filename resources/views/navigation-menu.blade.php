<nav x-data="{ open: false, buquesOpen: false }" class="bg-white border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="https://www.cotecmar.com/sites/default/files/media/imagenes/2023-12/CotecmarLogo.png" alt="Cotecmar Logo" class="block h-9 w-auto">
                    </a>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex items-center">
                    <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" class="transition duration-300 ease-in-out hover:text-gray-700 ">
                        {{ __('Panel de Control') }}
                    </x-nav-link>
                    <!-- Buques dropdown -->
                    <div @mouseenter="buquesOpen = true" @mouseleave="buquesOpen = false" class="relative">
                        <x-nav-link href="{{ route('buques.index') }}" :active="request()->routeIs('buques.*')" class="transition duration-300 ease-in-out hover:text-gray-700 ">
                            {{ __('Buques') }}
                        </x-nav-link>
                        <div x-show="buquesOpen" x-transition class="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md py-2">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('buques.index') }}" :active="request()->routeIs('buques.*')" class="transition duration-300 ease-in-out hover:text-gray-700">
                {{ __('Buques') }}
            </x-responsive-nav-link>
        </div>
